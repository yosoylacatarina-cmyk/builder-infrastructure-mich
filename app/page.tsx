    ...
    {[
      ...
      <section className="max-w-4xl mx-auto px-6 py-16">
        ...
        <div className="space-y-2 text-center">
          ...
          <p className="text-slate-400">Week 6: Integration, Final Venture - <a href="/demo" className="text-emerald-400 underline hover:text-emerald-300">View</a> · <a href="/dashboard" className="text-emerald-400 underline hover:text-emerald-300">Pricing</a></p>
        </div>
      </section>
